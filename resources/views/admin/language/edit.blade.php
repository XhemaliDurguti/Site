            ...
            <div class="card-body">
                <form action="{{ route('admin.language.update',$language->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="text" value="{{ $language->name }}" id="name" name="name" class="form-control"/>
                        @error('name')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input readonly type="text" id="slug" value="{{ $language->slug }}"name="slug" class="form-control"/>
                        @error('lang')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
