            ...
            <div class="card-body">
                <form action="{{ route('admin.social-count.update',$socialCount->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="url" value="{{ $socialCount->url }}" class="form-control" id="name" />
                        @error('url')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fan_count" value="{{ $socialCount->fan_count }}" class="form-control" id="name" />
                        @error('fan_count')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fan_type" value="{{ $socialCount->fan_type }}" class="form-control" id="name"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="button_text" value="{{ $socialCount->button_text }}" class="form-control" id="name"
                            placeholder="ex:links, fans,followers" />
                        @error('button_text')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
