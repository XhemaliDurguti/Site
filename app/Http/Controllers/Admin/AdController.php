    ...
    public function update(AdminAdUpdateRequest $request, string $id)
    {
        ...
        Ad::updateOrCreate(
            ...
            [
                ...
                'home_middle_ad_status' => $request->home_top_bar_ad_status == 1 ? 1 : 0,
                'view_page_ad_status' => $request->home_top_bar_ad_status == 1 ? 1 : 0,
                'news_page_ad_status' => $request->home_top_bar_ad_status == 1 ? 1 : 0,
                'side_bar_ad_status' => $request->home_top_bar_ad_status == 1 ? 1 : 0,
